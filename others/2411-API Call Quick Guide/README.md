...
**数据**：有一些数据平台，如DeFiLlama，可以直接下载原始数据，这很好。有一些数据平台，如Dune，没有提供原始数据下载选项，使用API成为直接和灵活地获取数据的必要手段。
...
![image-20241109141856581](https://cdn.jsdelivr.net/gh/zey9991/mdpic/image-20241109141856581.png)
...
![image-20241109142938404](https://cdn.jsdelivr.net/gh/zey9991/mdpic/image-20241109142938404.png)

点击后，Dune提示我们：

![image-20241109145934613](https://cdn.jsdelivr.net/gh/zey9991/mdpic/image-20241109145934613.png)
